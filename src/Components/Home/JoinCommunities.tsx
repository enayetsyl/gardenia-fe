...
const JoinCommunities = () => {
  return (
    <div>
      <div className="flex flex-col items-center justify-center bg-background-dark py-10">
  ...
  <div className="flex flex-wrap justify-around w-full max-w-4xl">
    ...
    <div className="w-1/3 p-4 text-center">
      ...
      <p className="text-text-primary">Support and highlight the best tips!</p>
    </div>
    ...
    <div className="w-1/3 p-4 text-center">
      ...
      <p className="text-text-primary">Stay updated with expert gardeners.</p>
    </div>
    ...
    <div className="w-1/3 p-4 text-center">
      ...
      <p className="text-text-primary">Share your thoughts with others.</p>
    </div>
  </div>
