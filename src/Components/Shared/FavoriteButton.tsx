...
const FavoriteButton = ({
  ...
  return (
    <div
      className={`overflow-x-visible relative w-10 h-10 overflow-y-clip group text-center ${isLoading ? 'cursor-not-allowed opacity-50' : 'cursor-pointer'
      }`}
      onClick={onClick}
    >
      {
...
<div className="flex justify-center items-center w-10 h-10 rounded-full bg-background-dark transition-all duration-300 absolute top-0 group-hover:scale-[.60] group-hover:origin-top text-white">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="24"
          height="24"
