...
const ContactInfo = () => {
  return (
    <div className="bg-background-dark px-8 pt-8 pb-12 shadow-lg w-full">
      <h1 className="text-2xl font-semibold pb-5">Head Office</h1>
      <div className="space-y-10">
        <div className="flex items-center justify-start gap-5">
          <IoCall className=" font-bold text-white  text-5xl p-2 " />
        ...
        <div className="flex items-center justify-start gap-5">
          <FaRegEnvelope className=" font-bold text-white  text-5xl p-2 " />
          <div className="flex flex-col gap-1">
        ...
        <div className="flex items-center justify-start gap-5">
          <FaLocationDot className=" font-bold text-white  text-5xl p-2 " />
          <div className="flex flex-col gap-1">
