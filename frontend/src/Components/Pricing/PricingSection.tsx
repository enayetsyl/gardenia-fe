...
const PricingCard = () => {
  ...
  return (
    <div className="bg-background p-6 rounded-lg shadow-md">
      ...
      <p className="text-text-secondary mb-4">one-time verification fee</p>
      <p className="text-text-secondary mb-4">
        Unlock premium content and get a verified badge on your profile.
      </p>
      <p className="font-semibold text-primary mb-4">
        Verify once, enjoy premium benefits forever.
      </p>
      <CustomButton
...
const FeatureItem = ({
  ...
  <div className="flex flex-col items-center text-center mb-8 lg:mb-0">
    ...
    <h3 className="text-h3 lg:text-h3-lg font-semibold text-primary mb-2">
      {title}
    </h3>
      ...
      <CustomContainer>
        <div className="lg:flex lg:items-start lg:space-x-8">
          ...
          <div className="lg:w-2/3">
            <h2 className="text-h2 lg:text-h2-lg font-bold text-primary mb-4">
              Unlock Premium Gardening Content
            </h2>
            <p className="text-text-secondary mb-6">
              Verify your account to access exclusive gardening tips, guides,
              and premium content. Share your expertise and gain recognition in
              our community.
            </p>
            <p className="text-text-secondary mb-8">
              Verification is a one-time process that grants you lifetime access
              to premium features and a verified badge on your profile.
            </p>
          </div>
        </div>
